...
return [
    ...
    'cards' => [
        [
            'name' => 'digital comics',
            'url' => 'resources/img/buy-comics-digital-comics.png',
            'target' => '#'
        ],
        [
            'name' => 'dc merchandise',
            'url' => 'resources/img/buy-comics-merchandise.png',
            'target' => '#'
        ],
        [
            'name' => 'subscription',
            'url' => 'resources/img/buy-comics-subscriptions.png',
            'target' => '#'
        ],
        [
            'name' => 'comic shop locator',
            'url' => 'resources/img/buy-comics-shop-locator.png',
            'target' => '#'
        ],
        [
            'name' => 'dc power visa',
            'url' => 'resources/img/buy-dc-power-visa.svg',
            'target' => '#'
        ],
    ],
    'menu' => [
